...
SRC_EXE =	exec_built_ins.c exec_utils.c exec.c open_file.c redir_hdoc.c run_pipes.c heredoc.c
SRC_PRS	=	parse_counter.c parse_split.c parse_str.c
SRC_STC	=	cmd_utils.c content.c init.c
SRC_UTL	=	array_utl.c env_split_utl.c env_utl.c list_utl.c str_utl.c str_utl2.c
